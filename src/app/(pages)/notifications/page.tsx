...
import { NotificationsSkeleton } from '@/frontend/notification/NotificationSkeleton';
...
const Notification = () => {
  ...
  useEffect(() => {
    const fetchNotifications = async () => {
      setIsLoading(true); // we can skip this , by default true it is.
      try {
        ...
        console.log("Failed to fetch notifications , Error: " + err)
